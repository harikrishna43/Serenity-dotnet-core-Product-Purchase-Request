...
namespace ProductPurchaseApp.Texts {
    ...
    export declare namespace Db {
        ...
        namespace ProductPurchaseRequestDB {

            namespace ProductPurchaseRequest {
                export const Attachment: string;
                export const CreatedDate: string;
                export const ProductName: string;
                export const PurchaseRequestId: string;
    ...
    ProductPurchaseApp['Texts'] = proxyTexts(Texts, '', {
        Db: {
            Administration: {
                Language: {},
                Role: {},
...
export const Texts = ProductPurchaseApp.Texts;